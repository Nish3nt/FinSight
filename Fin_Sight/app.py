...
@@ -134,8 +166,8 @@ def get_news(ticker):
...
@@ -149,7 +181,6 @@ def compute_vader(posts):
...
try:
@@ -170,12 +201,7 @@ def fetch_stock_data(ticker, start, end):
...
@@ -185,64 +211,61 @@ def compute_features(raw):
...
st.markdown("""
       <div class="model-box">
@@ -251,676 +274,871 @@ def compute_features(raw):
